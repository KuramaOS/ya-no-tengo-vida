...
import { sampleWithRequiredData } from '../departamento.test-samples';
...
describe('Departamento Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to departamentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDepartamentoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDepartamentoIdentifier).toHaveBeenCalledWith(entity);
