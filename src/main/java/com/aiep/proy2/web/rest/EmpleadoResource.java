...
import com.aiep.proy2.repository.EmpleadoRepository;
...
/**
 * REST controller for managing {@link com.aiep.proy2.domain.Empleado}.
 */
@RestController
...
public class EmpleadoResource {
    ...
    public ResponseEntity<Empleado> createEmpleado(@Valid @RequestBody Empleado empleado) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/empleados/" + empleado.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, empleado.getId().toString()))
            .body(empleado);
    }
    ...
    public ResponseEntity<Empleado> partialUpdateEmpleado(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, empleado.getId().toString())
        );
    }
